...
#define HHH1D
	...
	//#define HH1D_WINDOW
	#define HHH1D_WINDOW_RAND

	#include "shared.h"
	#include "../../../hhh_source/nonWindowHHH-openSource/randhhh1D.h"
...
////////////////////////////////////////////////////////////////////////
	...
	if (an_bit == AN_REQ_HTTP_PROCESS_FE) {
		...
		// Reverse (netrork order) client's IP
		hh1d_reversed_ip_number = ((hh1d_ip_number>>24)&0xff) | // move byte 3 to byte 0
								  ((hh1d_ip_number<<8)&0xff0000) | // move byte 1 to byte 2
								  ((hh1d_ip_number>>8)&0xff00) | // move byte 2 to byte 1
								  ((hh1d_ip_number<<24)&0xff000000); // byte 0 to byte 3
		
		// Update HHH with current IP																	  
		window_hh_update(hh1d_reversed_ip_number);
		
		// Print results			
		printf("IP %u.%u.%u.%u OCCURENCES %u\n", 
							(hh1d_reversed_ip_number>>24)&0x000000FF, 
							(hh1d_reversed_ip_number>>16)&0x000000FF, 
...
////////////////////////////////////////////////////////////////////////
	...
	if (an_bit == AN_REQ_HTTP_PROCESS_FE) {
		...
		// Update HHH with current IP																	  
		wrhhh1d_update(hh1d_reversed_ip_number);
